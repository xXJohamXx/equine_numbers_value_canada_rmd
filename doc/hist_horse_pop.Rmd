...
```{r plot horses, fig.width=10, fig.height=3, fig.cap='Figure Number of horses per province between 1906 and 1972', out.width='80%', out.height='80%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Range of the number horses for each provinces at any time point between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

Figure 2. Historical number of horses in `r params$province`
```{r plot province, fig.width=5, fig.height=4, out.width='80%', out.height='80%'}
